...
public class HostOrJoinGamePanel extends JPanel {
    ...
    public HostOrJoinGamePanel(HostOrJoinGameControl hj) throws IOException {
        ...
        // get original images
        BufferedImage original_background_image = ImageIO.read(getClass().getResource("/assets/background.png"));
        BufferedImage original_host_image = ImageIO.read(getClass().getResource("/assets/host_button.png"));
        BufferedImage original_join_image = ImageIO.read(getClass().getResource("/assets/join_button.png"));
        BufferedImage original_logout_image = ImageIO.read(getClass().getResource("/assets/logout_button.png"));
