...
public class InitialPanel extends JPanel {
    ...
    public InitialPanel(InitialControl ic) throws IOException {
        ...
        BufferedImage original_title_image = ImageIO.read(getClass().getResource("/assets/ASCEND.png"));
        BufferedImage original_login_image = ImageIO.read(getClass().getResource("/assets/login_button.png"));
        BufferedImage original_create_image = ImageIO.read(getClass().getResource("/assets/create_button.png"));
