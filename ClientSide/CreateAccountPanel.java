...
public class CreateAccountPanel extends JPanel {
    ...
    public CreateAccountPanel(CreateAccountControl cac) throws IOException{
        ...
        // get original images
        BufferedImage original_background_image = ImageIO.read(getClass().getResource("/assets/background_2.png"));
        BufferedImage original_submit_image = ImageIO.read(getClass().getResource("/assets/submit_button.png"));
